...
public class SignupThree extends JFrame implements ActionListener{
	...
	SignupThree(String formno){
		...
		cnumber.setBounds(100, 330, 300, 20);
		add(cnumber);
		...
		JLabel ppnumber = new JLabel("Your 4 Digit Password");
		ppnumber.setFont(new Font("Raleway", Font.BOLD, 12));
		ppnumber.setBounds(100, 410, 300, 20);
		add(ppnumber);
